...
python run_experiments.py --exp_name IntrinsicMotivation-NumCells-Montezuma --games MontezumaRevenge --seeds 0 --frame 5000000 --widths 8 24 --heights 8 --depths 16 --selector Random StochAccept
